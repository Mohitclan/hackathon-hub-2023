    ...
    <section id="sponsors" className="section-padding bg-gradient-to-b from-marvel-black to-marvel-darkblue relative">
      ...
      <div className="container mx-auto px-6 relative">
        <Transition animation="fade-in-up">
          <h2 className="section-heading text-marvel-gold">
        ...
        <div className="mt-12">
          <h3 
            ...
            style={{ textShadow: '0 2px 8px rgba(253, 184, 39, 0.2)' }}
          >
            Platinum Sponsors
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {SPONSORS.main.map((sponsor, index) => (
              <Transition key={index} animation="fade-in-up" delay={300 + index * 100}>
                <div className="bg-black/40 backdrop-blur-sm p-8 rounded-xl border border-marvel-blue/20 hover:border-marvel-gold/50 transition-all duration-300 flex items-center justify-center h-40 hover:shadow-md">
                  <img 
                    src={sponsor} 
                    alt={`Sponsor ${index + 1}`} 
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {SPONSORS.supporting.map((partner, index) => (
              <Transition key={index} animation="fade-in-up" delay={500 + index * 100}>
                <div className="bg-black/40 backdrop-blur-sm p-6 rounded-xl border border-marvel-blue/20 hover:border-marvel-gold/50 transition-all duration-300 flex items-center justify-center h-32 w-48 hover:shadow-md">
                  <img 
                    src={partner} 
                    alt={`Partner ${index + 1}`} 
                    className="max-h-full max-w-full object-contain hover:scale-105 transition-transform duration-300"
        ...
        <Transition animation="fade-in-up" delay={800}>
          <div className="bg-black/40 backdrop-blur-sm p-8 md:p-12 rounded-2xl border border-marvel-blue/20 hover:border-marvel-gold/50 transition-all duration-300 text-center max-w-3xl mx-auto mt-20">
            <h3 className="text-2xl font-semibold mb-4 text-marvel-gold font-orbitron">
              Become a Sponsor
            </h3>
            ...
            <a href="#contact" className="button-outline inline-block hover:scale-105 transition-all duration-300">
              Contact Us
            </a>
          </div>
        </Transition>
